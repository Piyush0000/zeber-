    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <div 
                key={index} 
                className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-fade-in-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="h-64 bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                  <div className="bg-white border-2 border-dashed rounded-full w-32 h-32 flex items-center justify-center text-gray-400">
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 animate-fade-in-up">Diverse Expertise, Unified Vision</h2>
          <p className="text-xl text-gray-700 mb-16 max-w-3xl mx-auto animate-fade-in-up delay-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up delay-200">
              <div className="text-5xl mb-6 text-blue-500">💻</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Top Tech Alumni</h3>
              <p className="text-gray-600">
                Former employees from Google, Microsoft, Amazon, IBM, and Meta
              </p>
            </div>
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up delay-300">
              <div className="text-5xl mb-6 text-purple-500">🎓</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Elite Education</h3>
              <p className="text-gray-600">
                Graduates from IITs, IIITs, MIT, Stanford, and top business schools
              </p>
            </div>
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up delay-400">
              <div className="text-5xl mb-6 text-indigo-500">🤝</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Multidisciplinary</h3>
              <p className="text-gray-600">
